...
- **การบันทึกค่า**: หากมีการแก้ไขการตั้งค่า (Settings) หรือคอนฟิกูเรชันต่างๆ ให้บันทึกข้อมูลเหล่านั้นลงในไฟล์ `.agent/project.md` เสมอ
- **การสร้าง project.md**: เมื่อเริ่มโปรเจกต์ใหม่ ให้สอบถามข้อมูลเพื่อสร้างไฟล์ไว้ที่ `.agent/project.md` ตามโครงสร้างดังนี้:
